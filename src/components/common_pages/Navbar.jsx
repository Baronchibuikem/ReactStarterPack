  ...
  const list = (anchor) => (
    ...
    >
      ...
      <div className="mt-5">
        ...
        <ListItem button>
          <ListItemIcon><InboxIcon style={{ color: "white" }} /></ListItemIcon><ListItemText>Profile</ListItemText>
        </ListItem>
        <ListItem button>
          <ListItemIcon><InboxIcon style={{ color: "white" }} /></ListItemIcon><ListItemText>My poll</ListItemText>
        </ListItem>
        <ListItem button>
          <ListItemIcon><InboxIcon style={{ color: "white" }} /></ListItemIcon><ListItemText >Logout</ListItemText>
        </ListItem>
      </div> 
      {/* : */}
      <div>
